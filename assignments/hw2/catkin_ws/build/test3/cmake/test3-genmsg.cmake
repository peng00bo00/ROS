...
get_filename_component(_filename "/home/pengbo/ROS/assignments/hw2/catkin_ws/src/test3/srv/turtleSrv.srv" NAME_WE)
add_custom_target(_test3_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "test3" "/home/pengbo/ROS/assignments/hw2/catkin_ws/src/test3/srv/turtleSrv.srv" ""
)
...
_generate_srv_cpp(test3
  "/home/pengbo/ROS/assignments/hw2/catkin_ws/src/test3/srv/turtleSrv.srv"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/test3)
  install(CODE "execute_process(COMMAND \"/home/pengbo/anaconda3/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/test3\")")
  # install generated code
  install(
