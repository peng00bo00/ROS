...
(cl:defmethod cl:initialize-instance :after ((m <PersonSrv-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PersonSrv-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name test3-srv:<PersonSrv-request> is deprecated: use test3-srv:PersonSrv-request instead.")))
...
(cl:defmethod age-val ((m <PersonSrv-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader test3-srv:age-val is deprecated.  Use test3-srv:age instead.")
  (age m))

(cl:ensure-generic-function 'sex-val :lambda-list '(m))
(cl:defmethod sex-val ((m <PersonSrv-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader test3-srv:sex-val is deprecated.  Use test3-srv:sex instead.")
  (sex m))
...
(cl:defmethod cl:initialize-instance :after ((m <PersonSrv-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PersonSrv-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name test3-srv:<PersonSrv-response> is deprecated: use test3-srv:PersonSrv-response instead.")))
