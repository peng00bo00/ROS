...
set(MSG_I_FLAGS "-Irobot_vision:/home/pengbo/ROS/assignments/hw6/src/robot_vision/msg;-Istd_msgs:/opt/ros/noetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/pengbo/ROS/assignments/hw6/src/robot_vision/msg/FaceMsg.msg" NAME_WE)
add_custom_target(_robot_vision_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "robot_vision" "/home/pengbo/ROS/assignments/hw6/src/robot_vision/msg/FaceMsg.msg" ""
)
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/robot_vision)
  install(CODE "execute_process(COMMAND \"/home/pengbo/anaconda3/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/robot_vision\")")
  # install generated code
  install(
