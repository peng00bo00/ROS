...
class Detector:
    ...
    def control_msg(self, objArray):
        global found, x, y, h, w

        msg = Twist()

        for detection in objArray.detections:
            ...
            if int(Id) == 1:
                ...
                if (detection.bbox.center.x - x > 10):
                    msg.angular.z = -2.0
                    print("Turn right!")
                elif (detection.bbox.center.x - x < -10):
                    msg.angular.z = 2.0
                    print("Turn left!")
                
                if (detection.bbox.size_x - w > 10) and (detection.bbox.size_y - h > 10):
                    msg.linear.x = 10.0
                    print("Go forward!")
                elif (detection.bbox.size_x - w < -10) and (detection.bbox.size_y - h < -10):
                    msg.linear.x = -10.0
                    print("Go Backward!")
